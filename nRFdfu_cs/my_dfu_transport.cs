...
namespace nRFdfu_cs
{
    ...
    def send_start_dfu(self, program_mode, softdevice_size=0, bootloader_size=0, app_size=0):
        ...
        pass
        */
        public void send_start_dfu(int program_mode, int softdevice_size = 0, int bootloader_size = 0, int app_size = 0)
        {
        }
    ...
    def send_init_packet(self, init_packet):
        ...
        pass
        */
        public void send_init_packet(Byte[] init_packet)
        {
        }
    ...
    def send_firmware(self, firmware):
        ...
        pass
        */
        public void send_firmware(Byte[] firmware)
        {
        }
    ...
    def send_validate_firmware(self):
        ...
        pass
        */
        public void send_validate_firmware()
        {
        }
    ...
    def send_activate_firmware(self):
        ...
        pass
        */
        public void send_activate_firmware()
        {
        }
    ...
    def _send_event(self, event_type, **kwargs):
        ...
        */
        ...
        public void register_events_callback(DfuEvent event_type, timeout_event_handler_del callback)
        {
